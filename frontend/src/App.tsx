    ...
    <div className="app">
      ...
      <header className="app-header">
        <div className="app-header__inner">
          <a className="app-brand-link" href="/" aria-label="Snippet manager home">
          ...
          <button type="button" className="avatar-btn" aria-label="Open profile menu" aria-haspopup="menu">
